...
const sendOrderRequest = async (data) => {
  try {
    ...
    console.log('✅ Quotation request email sent to admin:', info.messageId);

    // Send confirmation email to customer
    const customerCartItemsHtml = data.cart_items.map(item => 
    ...
    console.log('✅ Quotation confirmation email sent to customer');
