    ...
    <section id="about" className="py-16 bg-muted/20">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">Welcome to CineGear Pro</h2>
          <div className="w-20 h-1 bg-primary mx-auto mb-6"></div>
          <p className="text-muted-foreground max-w-3xl mx-auto text-lg">
            Your premier destination for professional camera equipment rental. We offer top-of-the-line cameras, lenses, lighting, and accessories 
            for photographers and videographers who demand the best tools for their craft.
          </p>
        </div>
        ...
        <div className="max-w-4xl mx-auto bg-card p-8 rounded-lg shadow-sm border">
          ...
          <p className="mb-6 text-muted-foreground">
            At CineGear Pro, we're passionate about helping creators bring their vision to life. Whether you're shooting a blockbuster film, 
